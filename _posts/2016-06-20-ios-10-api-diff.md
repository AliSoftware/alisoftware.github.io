...
* 🚨 At the end of 2016, Apple will make ATS[^ATS] mandatory for all developers who hope to submit their apps to the App Store. You'll need to **justify** if you still need to use exceptions (like if you're talking with a partner server you don't have controller over). (🎬706)
